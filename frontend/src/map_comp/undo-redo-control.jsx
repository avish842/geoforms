...
console.log(state);
  ...
  return (
    <div className="flex items-center gap-1 bg-white rounded-sm shadow-md" style={{marginTop: '5px', height: '28px'}}>
      <button
        className="flex items-center justify-center w-8 h-6 rounded-md text-neutral-600 hover:bg-neutral-100 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
      ...
      <button
        className="flex items-center justify-center w-8 h-8 rounded-md text-neutral-600 hover:bg-neutral-100 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
